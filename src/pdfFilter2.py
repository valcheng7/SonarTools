...
#                 dic.append(k["src"][0:k["src"].index(":")])
#                 dic.append(k["src"][k["src"].index(":")+1:])
#                 dic.append(k["message"])
#                 dic.append(k["type"])
#                 dic.append(k["severity"])
#                 dic.append(k["status"])
#                 dic.append(k["effort"])
#                 dic.append(k["creationDate"])
#                 dic.append(k["startLine"])
#                 li.append(dic)
#     return li
...
def pdfFilterProjectIssues(project_issues_data, parameters):
