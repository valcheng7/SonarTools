def pdfFilterProjects(project_data, parameters):
    ...
    li = [['Project', 'Status', 'Bugs', 'Vulnerabilities', 'Hotspots Reviewed', 'Code Smells', 'Coverage', 'Duplications', 'Language']]
    for i, j in enumerate(project_data):
        dic = []
